...
module.exports = class extends GeneratorBase {
  ...
  initializing() {
    super._storeConfig('project-type', 'js')
  }
    ...
    return {
      coreDependencies(generator) {
        ...
        generator.yarnInstall(
          ['core.js', 'vue@next', 'vue-router@next', 'vuex@next', 'normalize.css', 'nprogress'],
          {
            dev: false
          }
        )
  ...
  _end() {
    return {
      ...
      svgInjection(generator) {
        ...
        // Adding Icon import
        const mainJs = `${generator.destinationPath()}/src/main.js`
    ...
    this.log(`${chalk.green.bold('✔ Dependencies installation installed\n')}`)
    // Injecting SVG codes
